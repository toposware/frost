...
mod dkg_benches {
    ...
    fn participant_new(name: &str, n: u32, t: u32, c: &mut Criterion) {
        ...
        c.bench_function(&bench_name, move |b| b.iter(|| Participant::new(&params, 1)));
    }
    ...
    fn round_two_t_out_of_n(name: &str, n: u32, t: u32, c: &mut Criterion) {
        ...
        let mut p1_my_secret_shares = Vec::<SecretShare>::with_capacity((n - 1) as usize);
...
mod sign_benches {
    ...
    fn partial_sign_t_out_of_n(name: &str, n: u32, t: u32, c: &mut Criterion) {
        ...
        for i in 2..n+1 {
            let mut pi_my_secret_shares = Vec::<SecretShare>::with_capacity((n - 1) as usize);
